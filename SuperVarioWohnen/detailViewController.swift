...
class detailViewController: UIViewController,  UICollectionViewDataSource ,UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "ordner2", for: indexPath) as!  Document1CollectionViewCell
        
        cell.myLabel.text = pdfname
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        {
            if self.collectionview.indexPath(for: (sender as? Document1CollectionViewCell)!) != nil
            {
